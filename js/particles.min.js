...
var pJS = function(e, a) {
  ...
  a && Object.deepExtend(i, a),
    ...
    (i.fn.modes.repulseParticle = function(e) {
      if (
        ...
        var a = e.x - i.interactivity.mouse.pos_x,
          ...
          c = clamp(
            1 /
              (l = i.interactivity.modes.repulse.distance) *
              (-1 * Math.pow(n / l, 2) + 1) *
              l *
              100,
            0,
          ...
          d <= l &&
            (function() {
              ...
              if (
                ...
                var t = e.x + e.vx,
                  n = e.y + e.vy;
                t + e.radius > i.canvas.w
                  ? (e.vx = -e.vx)
                  : t - e.radius < 0 && (e.vx = -e.vx),
                  n + e.radius > i.canvas.h
                    ? (e.vy = -e.vy)
                    : n - e.radius < 0 && (e.vy = -e.vy);
              }
            })();
        } else
    ...
    (i.fn.vendors.createSvgImg = function(e) {
      var a = i.tmp.source_svg.replace(/#([0-9A-F]{3,6})/gi, function(
          a,
          t,
          i,
          n
  ...
  particlesJS("particles-js", {
    particles: {
      ...
      opacity: {
        value: 0.5,
        random: !1,
        anim: { enable: !1, speed: 1, opacity_min: 0.9, sync: !1 }
      },
      size: {
        value: 5,
        random: !0,
